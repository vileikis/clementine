...
export default function AdminLayout({
  ...
  // Hide admin header for event builder pages (e.g., /events/[eventId]/*)
  const isEventBuilderPage = pathname.match(/^\/events\/[^/]+\//)
  const showHeader = !isEventBuilderPage
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className={showHeader ? "container mx-auto px-4 py-8" : ""}>{children}</main>
    </div>
  )
}
