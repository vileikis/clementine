...
- TypeScript 5.7 (strict mode) + TanStack Start 1.132, React 19.2, Firebase SDK (Firestore client, Admin), TanStack Router 1.132, TanStack Query 5.66, Zustand 5.x (to be removed) (010-session-workspace-persistence)
