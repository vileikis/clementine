...
- TypeScript 5.7.2 (strict mode, ES2022 target) + React 19.2.0, shadcn/ui, Radix UI, class-variance-authority (018-ui-kit-refactor)
- N/A (pure refactoring, no data changes) (018-ui-kit-refactor)
