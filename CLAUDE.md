...
- TypeScript 5.7.2 (strict mode, ES2022 target) + TanStack Start 1.132, React 19.2, TanStack Query 5.66, Zod 4.1, Firebase SDK 12.5 (041-ai-presets-crud)
- Firestore (subcollection: `/workspaces/{workspaceId}/aiPresets/{presetId}`) (041-ai-presets-crud)
