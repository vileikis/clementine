...
export const updateThemeSchema = z.object({
  ...
  primaryColor: z.string().regex(COLOR_REGEX, "Invalid hex color format").optional(),
  text: z
    .object({
      color: z.string().regex(COLOR_REGEX, "Invalid hex color format").optional(),
  ...
  button: z
    .object({
      backgroundColor: z
        ...
        .nullable()
        .optional(),
      textColor: z.string().regex(COLOR_REGEX, "Invalid hex color format").optional(),
