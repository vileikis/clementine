 ...
 *
 * Reference media = static media from node's refMedia array
 * Storage format: @{ref:displayName}
 *
 * Color coding:
...
export class MediaMentionNode extends TextNode {
  ...
  static importJSON(serialized: SerializedMediaMentionNode): MediaMentionNode {
    const node = $createMediaMentionNode(serialized.mediaName)
  ...
  constructor(mediaName: string, text?: string, key?: NodeKey) {
 ...
 *
 * @param mediaName - Display name of the media asset (used for storage)
