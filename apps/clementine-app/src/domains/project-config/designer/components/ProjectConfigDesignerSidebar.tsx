/**
 * ProjectConfigDesignerSidebar Component
 *
 * Composable sidebar navigation for the project config designer.
...
interface ProjectConfigDesignerSidebarProps {
  items: SidebarItem[]
}
...
export function ProjectConfigDesignerSidebar({
  items,
}: ProjectConfigDesignerSidebarProps) {
  const matchRoute = useMatchRoute()
  const { workspaceSlug, projectId } = useParams({
    from: '/workspace/$workspaceSlug/projects/$projectId',
  })
