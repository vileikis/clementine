 ...
 * stores integration in workspace, and returns redirect path.
 */
...
import { encrypt } from '@/server/encryption.server'
...
export const handleDropboxCallbackFn = createServerFn({ method: 'GET' })
  .inputValidator(
