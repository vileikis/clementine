...
/**
 * Options for building job snapshot
 */
interface BuildJobSnapshotOptions {
  /** Pre-resolved overlay to apply (resolved at job creation) */
 ...
 *
 * Captures the current state of session responses and type config
